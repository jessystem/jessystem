...
##  Sobre mim
Sou uma profissional em **transição de carreira** para a área de Dados, apaixonada por análise e visualização de informações. 

Atualmente, estou consolidando minha base técnica com foco em **Python, SQL e estatística aplicada**, e cursando graduação em **Ciência de Dados na FIAP**. Minha jornada está focada no aprendizado contínuo para transformar dados em soluções de negócio.
...
<a href="mailto:jessicagambs@outlook.com"><img loading="lazy" src="https://img.shields.io/badge/Outlook-0078D4?style=for-the-badge&logo=microsoft-outlook&logoColor=white" target="_blank"></a>
